      ...
      <div onClick={(e) => e.stopPropagation()} style={{ width: "100%", maxWidth: 520, maxHeight: "85vh", overflowY: "auto", background: COLORS.navyLight, border: `1px solid ${COLORS.navyMid}`, borderRadius: 16, boxShadow: "0 24px 70px rgba(0,0,0,0.55)" }}>
        ...
        <div style={{ padding: 22 }}>
          <Section label="What this is">
            A working demo of an AI-powered enablement agent for a fictional SaaS company called Meridian. It's built on patterns that are real and transferable. Two audiences share one tool: clients get guided onboarding and self-directed learning, while the internal team gets co-pilots, a live client-activity feed, and one-click Jira ticket drafting. Nothing you enter is stored or saved after your session.
          </Section>
